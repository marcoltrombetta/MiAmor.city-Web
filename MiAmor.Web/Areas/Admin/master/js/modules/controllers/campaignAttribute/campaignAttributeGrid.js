 ...
 * Module: UIGridController
  =========================================================*/
App.controller('CampaignAttributeUIGridController', ['$scope', 'uiGridConstants', 'uigridUtils', '$http', '$state', '$stateParams', function ($scope, uiGridConstants, uigridUtils, $http, $state, $stateParams) {

    var data = [];
    var filtersObject = [];
    var headerTemplate = uigridUtils.headerTemplateVal();
    var paginationOptions = uigridUtils.paginationOptionsVal();
    var editBtnCampaignDelivery = uigridUtils.editBtn('app.mainCampaignAttribute.editCampaignAttribute({id:row.entity.Id})');
    ...
    $scope.gridOptionsComplex.onRegisterApi = function (gridApi) {
        ...
        gridApi.edit.on.afterCellEdit($scope, function (rowEntity, colDef, newValue, oldValue) {
            var url = '/CampaignAttributeAdmin/EditCampaignAttribute';
            uigridUtils.cellEdit(url, rowEntity, colDef, newValue, oldValue);
        });
    };

    $scope.Delete = function (row) {
        var url = '/CampaignAttributeAdmin/DeleteCampaignAttribute';
    ...
    $scope.editCampaignAttribute = function () {
        $state.go('app.editCampaignAttribute');
    };

    var getPage = function (FilterValue) {
        var url = '/CampaignAttributeAdmin/GetFilteredCampaignAttributes';
