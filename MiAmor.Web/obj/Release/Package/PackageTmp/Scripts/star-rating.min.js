...
(function ($) {
    ...
    Rating.prototype = {
        ...
        _parseAttr: function (vattr, options) {
            ...
            if ($el.attr('type') === 'range' || $el.attr('type') === 'number' || $el.attr('type') === 'showclear') {
        ...
        renderClear: function () {
            var self = this, css;
            self.showClear = validateAttr(self.$element, 'showClear', self.options);
            if (!self.showClear || self.showClear=="false") {
                return '';
            }
        ...
        renderCaption: function () {
            ...
            self.showCaption = validateAttr(self.$element, 'showCaption', self.options);
            if (!self.showCaption || self.showCaption == "false") {
                return '';
            }
